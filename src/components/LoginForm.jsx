    ...
    return (
        <div>
            <div className="loginForm d-flex">
                    <button type="button" className="close position-absolute closeButton ml-auto " aria-label="Close" onClick={() => {props.setLogin(false)}}>
                        ...
                        <form className="mt-xl-0 mt-4">
                            ...
                            <div className="form-group mb-xl-2 mb-5">
                                <Field name={'password'} legendname="Пароль" placeholder="Пароль" id='password' component='input'
                                       type="password" className="form-control border-top-0 border-right-0 border-left-0"/>
                            </div>
                            <div className="custom-control custom-checkbox my-1 mr-sm-2 mb-xl-2 mb-3">
                                ...
                                <label className="custom-control-label loginFormRememberMe" htmlFor="remember">Запомнить меня</label>
                            </div>
                            <div>
            ...
            <div className="loginFormSell" onClick={() => {props.setLogin(false)}}/>
        </div>
    );
};
