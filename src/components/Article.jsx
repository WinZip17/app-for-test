                ...
                <div className="p-xl-5 d-flex flex-xl-row flex-column articleBackground pt-xl-0 pt-3">
                    <div className="d-flex flex-column col-sm">
                        <div className="d-flex flex-column align-self-center w-100 h-75 mb-2">
                            <div className="align-self-center">
                                <button className="btn btn-primary buttonWidth btn-lg buttonFontSize"><img
                                    className="buttonImg" src={loadFile} alt={loadFile}/> СКАЧАТЬ ПРИЛОЖЕНИЕ
                                </button>
                            </div>
                        ...
                        <div className="d-flex flex-column align-self-center w-100">
                            <div className="align-self-center">
                                <button className="btn btn-danger buttonWidth btn-lg buttonFontSize"><img
                                    className="buttonImg" src={accountCircle} alt={accountCircle}/> СОЗДАТЬ УЧЕТНУЮ
                                    ЗАПИСЬ
                                </button>
                            </div>
                    ...
                    <div className="d-flex flex-column col-sm">
                        <div className="d-flex flex-column align-self-center w-100 h-75">
                            <div className="align-self-center">
                                <button className="btn btn-success buttonWidth btn-lg buttonFontSize" onClick={() => {
                                    props.setLogin(true)
                                }}><img className="buttonImg" src={calendar} alt={calendar}/> ЗАПЛАНИРОВАТЬ КОНФЕРЕНЦИЮ
                                </button>
                            </div>
                        ...
                        <div className="d-flex flex-column align-self-center w-100">
                            <div className="align-self-center">
                                <button className="btn btn-warning buttonWidth btn-lg buttonFontSize"><img
                                    className="buttonImg" src={groupPeople} alt={groupPeople}/> ПОДКЛЮЧИТЬСЯ К
                                    КОНФЕРЕНЦИИ
                                </button>
                            </div>
                            <p className="textArticle text-center">Если вы знаете CID конференции, вы можете
                                подключиться к ней прямо в браузере.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div className="d-flex flex-xl-row flex-column justify-content-center align-items-center">
                <button className="btn btn-outline-dark btn-sm m-xl-4 m-2 buttonFontSize"><img className="buttonImg"
                                                                                               src={key}
                                                                                               alt={key}/> Вход для
                    администратора
                </button>
